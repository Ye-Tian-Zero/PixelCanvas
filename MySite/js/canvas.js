    ...
    function setPainterTransform(scale) {
        //grid.style.transform = "scale(" + painterScale + ")";
    ...
    (function () {
        ...
        painterOperator.addEventListener("wheel", function (event) {
            ...
            //block.style.height = block.style.width = painterScale * 1 + "px";
    ...
    colorForm.addEventListener("input", function(event){
        ...
        yourColorBlock.style.backgroundColor = "rgb(" + colorForm.rrange.value + "," +
                                            colorForm.grange.value + "," + colorForm.brange.value + ")";
